...
# -*- coding: utf-8 -*-
"""
POSCO 워치햄스터 v2 알림 시스템 통합 테스트

Task 5: v2 NotificationManager로 알림 시스템 향상 테스트
- 기존 알림 텍스트 보존 확인
- v2 컴포넌트 정보 포함 확인
- 구조화된 긴급 알림 및 복구 상태 알림 테스트
...
sys.path.insert(0, os.path.join(current_dir, 'Monitoring/Posco_News_mini'))

class TestV2NotificationIntegration(unittest.TestCase):
    """v2 알림 시스템 통합 테스트"""
    ...
    def setUp(self):
        ...
        try:
            ...
            self.skipTest(f"워치햄스터 초기화 실패: {e}")
    ...
    def test_v2_startup_notification_preserves_existing_text(self):
        ...
        """
        print("\n🧪 테스트: v2 시작 알림 기존 텍스트 보존")
        
        # v2 컴포넌트 Mock 설정
        self.watchhamster.v2_enabled = True
        self.watchhamster.v2_components['notification_manager'] = Mock()
        self.watchhamster.v2_components['notification_manager'].send_startup_notification.return_value = True
        ...
        self.watchhamster.v2_components['notification_manager'].send_startup_notification.assert_called_once()
        
        # 호출 인자 확인
        call_args = self.watchhamster.v2_components['notification_manager'].send_startup_notification.call_args
    ...
    def test_v2_startup_notification_fallback(self):
        ...
        self.watchhamster.v2_enabled = True
        self.watchhamster.v2_components['notification_manager'] = Mock()
        self.watchhamster.v2_components['notification_manager'].send_startup_notification.return_value = False
        ...
        # 기존 텍스트 보존 확인
        self.assertIn("POSCO 워치햄스터 시스템 시작", payload['attachments'][0]['text'])
    ...
    def test_v2_status_report_enhanced_info(self):
        ...
        self.watchhamster.v2_enabled = True
        self.watchhamster.v2_components['notification_manager'] = Mock()
        self.watchhamster.v2_components['notification_manager'].send_status_report.return_value = True
        self.watchhamster.v2_components['notification_manager'].get_notification_stats.return_value = {
        ...
        # 프로세스 상태 Mock
        with patch.object(self.watchhamster, '_is_process_running', return_value=True), \
             patch.object(self.watchhamster, '_get_process_pid', return_value=12345):
            
            # v2 상태 보고 호출
            self.watchhamster.send_status_report_v2()
        
        # v2 NotificationManager 호출 확인
        self.watchhamster.v2_components['notification_manager'].send_status_report.assert_called_once()
        
        # SystemStatus 객체가 전달되었는지 확인
        call_args = self.watchhamster.v2_components['notification_manager'].send_status_report.call_args
    ...
    def test_v2_process_error_structured_notification(self):
        ...
        """
        print("\n🧪 테스트: v2 프로세스 오류 구조화된 알림")
        
        # v2 컴포넌트 Mock 설정
        self.watchhamster.v2_enabled = True
        self.watchhamster.v2_components['notification_manager'] = Mock()
        self.watchhamster.v2_components['notification_manager'].send_process_error.return_value = True
        ...
        # v2 NotificationManager 호출 확인
        self.watchhamster.v2_components['notification_manager'].send_process_error.assert_called_once_with(
    ...
    def test_v2_recovery_success_detailed_info(self):
        ...
        self.watchhamster.v2_enabled = True
        self.watchhamster.v2_components['notification_manager'] = Mock()
        self.watchhamster.v2_components['notification_manager'].send_recovery_success.return_value = True
        ...
        # v2 NotificationManager 호출 확인
        self.watchhamster.v2_components['notification_manager'].send_recovery_success.assert_called_once_with(
    ...
    def test_v2_critical_alert_structured_format(self):
        ...
        Requirements: 4.4
        """
        print("\n🧪 테스트: v2 긴급 알림 구조화된 형태")
        
        # v2 컴포넌트 Mock 설정
        self.watchhamster.v2_enabled = True
        self.watchhamster.v2_components['notification_manager'] = Mock()
        self.watchhamster.v2_components['notification_manager'].send_critical_alert.return_value = True
        ...
        # v2 NotificationManager 호출 확인
        self.watchhamster.v2_components['notification_manager'].send_critical_alert.assert_called_once_with(
    ...
    def test_notification_fallback_mechanism(self):
        ...
        # v2 비활성화 상태 시뮬레이션
        self.watchhamster.v2_enabled = False
        self.watchhamster.v2_components['notification_manager'] = None
        ...
        self.assertEqual(payload['botName'], "POSCO 워치햄스터 🐹🛡️")
...
def run_integration_test():
    """통합 테스트 실행"""
    print("🚀 POSCO 워치햄스터 v2 알림 시스템 통합 테스트 시작")
    print("=" * 60)
