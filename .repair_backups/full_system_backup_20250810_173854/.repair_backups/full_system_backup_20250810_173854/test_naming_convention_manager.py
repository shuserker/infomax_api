...
# REMOVED:             self.manager.detect_component_type("verify_folder_reorganization.py"),
    ...
    def test_filename_standardization(self):
        ...
        test_cases = [
            ...
            (".naming_backup/scripts/🎛️POSCO_제어센터_실행_v2.bat", "🎛️WatchHamster_v3.0_Control_Panel.bat"),
# REMOVED:             ("verify_folder_reorganization.py", "demo_watchhamster_v3.0_integration.py"),
# REMOVED:             ("final_integration_test_system.py", "test_watchhamster_v3.0_integration.py"),
