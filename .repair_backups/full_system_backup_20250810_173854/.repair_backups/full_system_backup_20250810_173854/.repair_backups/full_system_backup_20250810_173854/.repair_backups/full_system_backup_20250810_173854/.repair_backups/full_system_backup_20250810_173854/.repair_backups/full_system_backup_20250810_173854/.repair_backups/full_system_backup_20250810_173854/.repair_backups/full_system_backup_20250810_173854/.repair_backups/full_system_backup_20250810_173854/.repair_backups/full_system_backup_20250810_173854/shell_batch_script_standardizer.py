...
WatchHamster v3.0 및 POSCO News var_25080_8 호환
...
(r'lib_wt_common.bat', '🎛️WatchHamster_v3.0_Control_Panel.bat'),
...
(r'test_runner.sh', 'WatchHamster_v3.0.log'),
                                            ...
                                            # POSCO News var_25080_8 관련 스크립트
...
(r'test_watchhamster_v3.0_notification.py', 'demo_watchhamster_v3.0_integration.py'),
(r'test_watchhamster_v3.0_notification.py', 'test_watchhamster_v3.0_integration.py'),
                                                                    ]
...
- POSCO News 관련: var_25080_8 날짜 체계 적용
- 파일명: 이모지 및 표준 형식 적용
