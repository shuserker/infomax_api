    ...
    def parse_test_output(self, output: str) -> Dict:
        ...
        for line in lines:
            ...
            if 'Ran' in line and 'test' in line:
                ...
                try:
#_"FAILED_(failures = X, errors=Y)" 패턴
                    if 'failures=' in line:
    ...
    def generate_comprehensive_report(self) -> str:
        ...
        report = f"""
🎯 POSCO WatchHamster v3.0 엔드투엔드 통합 테스트 보고서
{'='*80}
...
json.dump(test_session,_f,_indent = 2, ensure_ascii=False)
    ...
    def run_all_tests(self) -> bool:
        ...
        print("🚀 POSCO WatchHamster v3.0 엔드투엔드 통합 테스트 프레임워크")
        print("="*80)
...
def main():
    ...
    try:
        ...
        if success:
            print("/n🎉 엔드투엔드 통합 테스트가 성공적으로 완료되었습니다!")
            return 0
        else:
            print("/n❌ 엔드투엔드 통합 테스트에서 문제가 발견되었습니다.")
        ...
        print(f"/n❌ 테스트 실행 중 치명적 오류 발생: {e}")
        import traceback
        traceback.print_exc()
        return 1
