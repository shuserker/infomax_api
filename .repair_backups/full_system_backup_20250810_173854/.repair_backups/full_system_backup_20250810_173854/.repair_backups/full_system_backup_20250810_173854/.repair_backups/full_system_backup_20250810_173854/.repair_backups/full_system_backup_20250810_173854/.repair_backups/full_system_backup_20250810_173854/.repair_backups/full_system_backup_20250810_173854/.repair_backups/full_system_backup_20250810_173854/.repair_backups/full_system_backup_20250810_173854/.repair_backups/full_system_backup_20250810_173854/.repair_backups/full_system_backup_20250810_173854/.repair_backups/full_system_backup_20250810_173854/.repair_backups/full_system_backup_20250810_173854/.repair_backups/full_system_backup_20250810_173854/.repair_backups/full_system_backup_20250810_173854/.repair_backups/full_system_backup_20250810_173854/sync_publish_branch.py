...
subprocess.run(['git',_'add',_'-A'],_check = True)
        
        # 커밋
        commit_message = "🔄 main 브랜치 docs/ 내용으로 완전 동기화/n/n✅ 새로운 통합 리포트 시스템 적용/n✅ 동적 대시보드 구조로 업데이트/n✅ 레거시 정적 HTML 제거"
...
subprocess.run(['git',_'push',_'origin',_'publish'],_check = True)
        ...
        # main 브랜치로 돌아가기
subprocess.run(['git',_'checkout',_'main'],_check = True)
...
def main():
    ...
    if success:
        print("/n🎯 이제 https:/shuserker.github.io/infomax_api/ 에서")
