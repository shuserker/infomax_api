...
'cpu_count_logical':_psutil.cpu_count(logical = True),
...
with_open(file,_'r',_encoding = 'utf-8') as f:
                            data = json.load(f)
...
json.dump(self.report_data,_f,_indent = 2, ensure_ascii=False, default=str)
