...
time.sleep(1)
        ...
        # 테스트용 제어센터 스크립트 생성
        test_control_center = self.test_backup_dir / ".naming_backup/scripts/watchhamster_control_center.sh"
...
echo "테스트용 제어센터"
        ...
        # 테스트용 로그 파일 생성
        test_log = self.test_backup_dir / ".naming_backup/config_data_backup/watchhamster.log"
    ...
    def test_process_termination_logic(self):
        ...
        test_process = subprocess.Popen([
            'python3', '-c', 
# REMOVED:             'import time; print("테스트 프로세스 시작"); time.sleep(30)'
        ])
    ...
    def test_rollback_verification(self):
        ...
        # 제어센터 스크립트 존재 확인
        control_center_path = self.test_backup_dir / ".naming_backup/scripts/watchhamster_control_center.sh"
...
class RollbackIntegrationTest:
    ...
    def _check_backup_integrity(self) -> bool:
        ...
        required_items = ['Monitoring', '.naming_backup/scripts/watchhamster_control_center.sh']
        for item in required_items:
