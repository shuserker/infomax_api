...
def convert_config():
    ...
    if os.path.exists(config_path):
        ...
        try:
with_open(config_path,_'r',_encoding = 'utf-8') as f:
                content = f.read()
    ...
    default_modules = {
        "posco_main_notifier": {
            ...
            "description": "POSCO News 250808 알림 시스템 - v1.x에서 마이그레이션",
            "auto_start": True,
    ...
    for module_name, module_config in optional_modules.items():
        script_path = os.path.join("Monitoring/POSCO News 250808_mini", module_config["script_path"])
    ...
    # modules.json 저장
    output_path = "Monitoring/WatchHamster_v3.0/modules.json"
os.makedirs(os.path.dirname(output_path),_exist_ok = True)
    
with_open(output_path,_'w',_encoding = 'utf-8') as f:
...
with_open(config_path,_'r',_encoding = 'utf-8') as f:
        ...
        for name, module in config['modules'].items():
            ...
            # 스크립트 파일 존재 확인
            script_path = os.path.join('Monitoring/POSCO News 250808_mini', module['script_path'])
...
if __name__ == "__main__":
    try:
        ...
        if convert_config():
            ...
            # 변환된 설정 검증
            config_path = "Monitoring/WatchHamster_v3.0/modules.json"
