...
start_watchhamster() {
    ...
    # 이미 실행 중인지 확인
    if pgrep -f "Monitoring/POSCO_News_250808/Monitoring/POSCO_News_250808/integrated_report_scheduler.py" >/dev/null; then
    ...
    if [[ -f "Monitoring/POSCO_News_250808/Monitoring/POSCO_News_250808/integrated_report_scheduler.py" ]]; then
        nohup python3 Monitoring/POSCO_News_250808/integrated_report_scheduler.py > posco_monitor.log 2>&1 &
        local pid=$!
        sleep 2
        ...
        if kill -0 $pid 2>/dev/null; then
            ...
            print_error "WatchHamster v3.0 실패했습니다."
        fi
    elif [[ -f "Monitoring/POSCO_News_250808/backup_archive_20250806/disabled_monitors_20250803/Monitoring/POSCO_News_250808/backup_archive_20250806/disabled_monitors_20250803/run_monitor.py" ]]; then
...
stop_watchhamster() {
    ...
    local pids=$(pgrep -f "Monitoring/POSCO_News_250808/backup_archive_20250806/disabled_monitors_20250803/Monitoring/POSCO_News_250808/backup_archive_20250806/disabled_monitors_20250803/run_monitor.py")
    ...
    if [[ -n "$pids" ]]; then
        ...
        # 강제 종료
        local remaining_pids=$(pgrep -f "Monitoring/POSCO_News_250808/backup_archive_20250806/disabled_monitors_20250803/Monitoring/POSCO_News_250808/backup_archive_20250806/disabled_monitors_20250803/run_monitor.py")
...
# BROKEN_REF:     local log_files=(".naming_backup/config_data_backup/.naming_backup/config_data_backup/posco_monitor.log" "system.log" "error.log")
...
check_system_status() {
    ...
    local required_files=("Monitoring/POSCO_News_250808/backup_archive_20250806/disabled_monitors_20250803/Monitoring/POSCO_News_250808/backup_archive_20250806/disabled_monitors_20250803/run_monitor.py" "Monitoring/POSCO_News_250808/Monitoring/POSCO_News_250808/config.py" "requirements.txt")
