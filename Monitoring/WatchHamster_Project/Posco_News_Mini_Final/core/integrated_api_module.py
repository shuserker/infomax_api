...
try:
    ...
    try:
        ...
        # 개발 환경에서 직접 import
        from infomax_api_client import InfomaxAPIClient
        from api_data_parser import APIDataParser
        from api_connection_manager import APIConnectionManager, ConnectionStatus
...
if __name__ == "__main__":
    ...
    try:
        # 새로운 구조에서 설정 로드
        try:
            from ..config.environment_settings import load_environment_settings
        except ImportError:
            # 레거시 경로 fallback
