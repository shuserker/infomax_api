...
class WatchhamsterLauncher:
    ...
    def print_main_menu(self):
        ...
        print("\n🚀 메인 메뉴")
        print("-" * 40)
        print("[1] 🐹 POSCO 워치햄스터 시작 (포스코 뉴스 포함)")
        print("[2] 🧪 테스트 모드")
        print("[3] 📊 시스템 상태 확인")
        print("[4] 🧪 테스트 실행")
        print("[5] 🔧 관리 도구")
    ...
    def handle_full_watchhamster_system(self):
        """전체 워치햄스터 시스템 시작 (포스코 뉴스 포함)"""
        print("\n🐹 POSCO 워치햄스터 전체 시스템을 시작합니다...")
        print("📋 포함 기능:")
        print("  • 워치햄스터 모니터링 (상위 관리자)")
        print("  • 포스코 뉴스 모니터링 (하위 서비스)")
        print("  • 정기 상태 알림 (두레이 웹훅)")
        print("  • 자동 복구 시스템")
        print("-" * 50)
        
        start_monitoring_path = os.path.join(self.scripts_dir, 'start_monitoring.py')
        self.run_python_script(start_monitoring_path, "POSCO 워치햄스터 전체 시스템")
