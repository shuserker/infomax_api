...
# -*- coding: utf-8 -*-
"""
ModuleRegistry for POSCO WatchHamster System

JSON 기반 모듈 설정 시스템 및 동적 모듈 등록/해제 기능
...
class ModuleConfig:
    ...
    timeout: int = 30
    priority: int = 0  # 시작 우선순위 (낮을수록 먼저 시작)
...
class ModuleRegistry:
    ...
    def __init__(self, config_file: str = "modules.json"):
        """
        ModuleRegistry 초기화
