...
# -*- coding: utf-8 -*-
"""
서환마감 뉴스 실시간 모니터링 시작 스크립트

평일 16:00부터 18:30까지 서환마감 뉴스를 집중 모니터링합니다.
...
- 18:30 이후 일반 모니터링 (5분 간격)
- 자동 지연 알림 (17:00, 17:30, 18:00)
- 발행 즉시 알림 전송
"""
...
def main():
    ...
    print(f"🎯 대상: 서환마감 뉴스 (exchange-rate)")
    print("=" * 50)
