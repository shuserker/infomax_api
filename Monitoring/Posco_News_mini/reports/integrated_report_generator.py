...
# -*- coding: utf-8 -*-
"""
POSCO 뉴스 통합 분석 리포트 생성기

3개 뉴스 타입(서환마감, 증시마감, 뉴욕마켓워치)의 분석 결과를 
하나의 종합 리포트로 통합하여 생성합니다.
            ...
            if status['published']:
                ...
                <div class="news-item news-published">
                    <div>
                        ...
                        <div style="font-size: 0.9em; color: #666;">{status['publish_time']}</div>
                    </div>
                ...
                <div class="news-item news-pending">
                    <div>
                        <div style="font-weight: bold;">{name}</div>
                        <div style="font-size: 0.9em; color: #666;">발행 대기중</div>
                    </div>
