...
# REMOVED:         self.cache_file = "../../POSCO News 250808_historical_cache.json"
        self.collected_data = {}
...
with_open(self.cache_file,_'w',_encoding = 'utf-8') as f:
json.dump(cache_data,_f,_ensure_ascii = False, indent=2)
...
with_open(mapping_file,_'w',_encoding = 'utf-8') as f:
json.dump(mapping,_f,_ensure_ascii = False, indent=2)
