...
self.total_restarts_+ =  1
    ...
    def _restart_with_config(self, name: str) -> bool:
        ...
        default_configs = {
            "posco_main_notifier": {
                "script": "Monitoring/POSCO_News_250808/posco_main_notifier.py",
                "args": []
            },
            "realtime_news_monitor": {
                "script": "Monitoring/POSCO_News_250808/realtime_news_monitor.py", 
                "args": []
            },
            "integrated_report_scheduler": {
                "script": "Monitoring/POSCO_News_250808/integrated_report_scheduler.py",
                "args": []
            },
            "historical_data_collector": {
                "script": "Monitoring/POSCO_News_250808/historical_data_collector.py",
                "args": []
            }
        }
