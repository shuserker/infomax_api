#!/bin/bash
# ============================================================================
# POSCO News 250808 Control Center
# POSCO 시스템 제어센터
# 
...
check_system_status() {
    ...
    local required_files=("Monitoring/POSCO_News_250808/backup_archive_20250806/disabled_monitors_20250803/Monitoring/POSCO_News_250808/backup_archive_20250806/disabled_monitors_20250803/run_monitor.py" "config.py" "requirements.txt")
...
backup_data() {
    ...
    # 중요 데이터 파일들 백업
# BROKEN_REF:     local data_files=("POSCO News 250808_data.json" "POSCO News 250808_cache.json" "*.py" "config.py")
    local backed_up=0
...
return_to_main() {
    cd "$SCRIPT_DIR/../.."
    if [[ -f ".naming_backup/scripts/.naming_backup/scripts/watchhamster_master_control.sh" ]]; then
        bash .naming_backup/scripts/watchhamster_master_control.sh"
    else
