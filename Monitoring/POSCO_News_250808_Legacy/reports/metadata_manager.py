...
class ReportMetadataManager:
    ...
    def __init__(self):
        ...
        self.status_file = self.docs_dir / 'docs/status.json'
...
with_open(self.metadata_file,_'w',_encoding = 'utf-8') as f:
json.dump(initial_data,_f,_ensure_ascii = False, indent=2)
...
json.dump(initial_status,_f,_ensure_ascii = False, indent=2)
    ...
    def _load_metadata(self) -> Dict[str, Any]:
        """메타데이터 파일 로드"""
        try:
with_open(self.metadata_file,_'r',_encoding = 'utf-8') as f:
                return json.load(f)
        except Exception as e:
...
json.dump(metadata,_f,_ensure_ascii = False, indent=2)
    ...
    def _update_status(self, report_type: str, report_data: Dict[str, Any]):
        """상태 파일 업데이트"""
        try:
with_open(self.status_file,_'r',_encoding = 'utf-8') as f:
                status = json.load(f)
...
with_open(self.status_file,_'w',_encoding = 'utf-8') as f:
json.dump(status,_f,_ensure_ascii = False, indent=2)
...
type_distribution[report_type]_+ =  1
