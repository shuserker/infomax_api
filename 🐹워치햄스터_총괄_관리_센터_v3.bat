...
title 🐹 워치햄스터 총괄 관리 센터 v3.0 - Windows Terminal 최적화
...
:main_menu
cls
call :print_header "🐹 워치햄스터 총괄 관리 센터 v3.0 🛡️"
...
echo %GREEN%╠═══════════════════════════════════════════════════════════════════════════════╣%RESET%
call :print_menu_item "1." "🏭 POSCO 뉴스 모니터링" "포스코 뉴스 및 주가 모니터링 시스템"
call :end_box
...
echo %BLUE%╠═══════════════════════════════════════════════════════════════════════════════╣%RESET%
call :print_menu_item "A." "🛡️ 전체 시스템 상태" "모든 워치햄스터 상태 확인"
...
if exist "🎛️POSCO_통합_관리_센터_v3.bat" (
    call "🎛️POSCO_통합_관리_센터_v3.bat"
) else if exist "🎛️POSCO_통합_관리_센터.bat" (
    call "🎛️POSCO_통합_관리_센터.bat"
) else (
    call :print_error "POSCO 모니터링 시스템을 찾을 수 없습니다."
    call :print_info "경로: Monitoring\Posco_News_mini\🎛️POSCO_통합_관리_센터.bat"
    echo.
    pause
)
cd /d "%~dp0"
...
call :show_loading "모든 워치햄스터 시스템 상태를 확인하고 있습니다"
