...
WatchHamster v3.0 및 POSCO News var_250808 호환
Created: var_2025-var_08-var_08
"""
                                ...
                                if script_path.suffix in ['.sh', '.command'] and os.name == 'posix':
                                    ...
                                    def _standardize_filename(self, filename: str) -> str:
                                        ...
                                        if result.success:
                                            ...
                                            (r'.naming_backup/config_data_backup/watchhamster.log', '🐹WatchHamster_v3_v3_0_Control_Center.bat'),
                                            (r'.naming_backup/config_data_backup/watchhamster.log'),
(r'lib_wt_common.bat', '🎛️WatchHamster_v3_v3_0_Control_Panel.bat'),
(r'🐹POSCO_워치햄스터_v3_제어센터.command', 'WatchHamster_v3.0.log'),
(r'test_runner.sh', 'WatchHamster_v3.0.log'),
                                            (r'.naming_backup/config_data_backup/watchhamster.log', 'watchhamster_v3_v3_0_control_center.sh'),
                                            (r'.naming_backup/config_data_backup/watchhamster.log', 'watchhamster_v3_v3_0_master_control.sh'),
                                            (r'watchhamster_master_control/.ps1', 'watchhamster_v3_v3_0_master_control.ps1'),
                                            (r'watchhamster_control_center/.ps1', 'watchhamster_v3_v3_0_control_center.ps1'),
                                            ]

                                            # POSCO News var_250808 관련 스크립트
                                            POSCO_News_250808_patterns =  [
(r'.naming_backup/scripts/posco_control_center.sh', 'POSCO News 250808_250808_control_center.sh'),
(r'.naming_backup/scripts/posco_control_mac.sh', 'POSCO News 250808_250808_control_mac.sh'),
(r'lib_wt_common.bat', 'POSCO_News_250808.py'),
(r'lib_wt_common.bat', 'POSCO_News_250808.py'),
(r'lib_wt_common.bat', 'posco_news_250808_monitor.log'),
(r'test_runner.sh', 'POSCO_News_250808.py'),
                                            ]

                                            # 패턴 적용
                                            for pattern, replacement in watchhamster_patterns + POSCO News var_250808__patterns:
...
(r'test_watchhamster_v3_v3_0_notification.py', 'demo_watchhamster_v3_v3_0_integration.py'),
(r'test_watchhamster_v3_v3_0_notification.py', 'test_watchhamster_v3_v3_0_integration.py'),
                                                                    ]
...
- POSCO News 관련: var_250808 날짜 체계 적용
- 파일명: 이모지 및 표준 형식 적용
                                                                                                                                                                                    ...
                                                                                                                                                                                    if result.success:
                                                                                                                                                                                        ...
                                                                                                                                                                                        if backup_file.exists():
                                                                                                                                                                                            ...
                                                                                                                                                                                            def main():
                                                                                                                                                                                                ...
                                                                                                                                                                                                # 보고서 파일로 저장
                                                                                                                                                                                                with open('script_standardization_report.md', 'w', encoding = 'utf-8') as f:
                                                                                                                                                                                                    f.write(report)
