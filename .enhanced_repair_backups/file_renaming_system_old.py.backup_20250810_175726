...
class FileOperation:
    ...
    success:_bool =  False
    error_message: str = ""
    rollback_completed:_bool =  False
...
def __init__(self, workspace_root: str = "."):
    ...
    self.operations_log:_List[FileOperation] =  []
    self.mapping_table:_List[MappingEntry] =  []
    ...
    # 작업 로그 파일
# REMOVED:     self.operations_log_file = self.backup_dir / "final_integration_test_system.py"
    self.mapping_table_file = self.backup_dir / ".naming_backup/mapping_table.json"
...
def analyze_existing_files(self) -> Dict[ComponentType, List[MappingEntry]]:
    ...
    # 분석할 파일 패턴들
    file_patterns = [
# REMOVED:     "**/*.py", "**/*.bat", "**/*.sh", "**/*.command", "**/*.md",
# REMOVED:     "**/*.json", "**/*.log", "**/*.html", "**/*.css", "**/*.js"
    ]
    ...
    for pattern in file_patterns:
        ...
        """
                                                                            self.logger.info(f"워치햄스터_파일_이름_변경_시작_(dry_run = {dry_run})")
        ...
        Returns:
            List[FileOperation]: 수행된 작업 목록
        """
                                                                                    self.logger.info(f"POSCO_News_250808_시작_(dry_run = {dry_run})")

                                                                                    POSCO_News_250808_entries =  [
                                                                                    entry for entry in self.mapping_table
                                                                                                                                    ...
                                                                                                                                    try:
                                                                                                                                        ...
                                                                                                                                        for entry_data in mapping_data:
                                                                                                                                            if entry_data['last_modified']:
                                                                                                                                                ...
                                                                                                                                                with_open(self.mapping_table_file,_'w',_encoding = 'utf-8') as f:
                                                                                                                                                    json.dump(mapping_data,_f,_ensure_ascii = False, indent=2)
                                                                                                                                                ...
                                                                                                                                                def _save_operations_log(self):
                                                                                                                                                    ...
                                                                                                                                                    try:
                                                                                                                                                        ...
                                                                                                                                                        for operation in self.operations_log:
                                                                                                                                                            ...
                                                                                                                                                            with_open(self.operations_log_file,_'w',_encoding = 'utf-8') as f:
                                                                                                                                                                json.dump(operations_data,_f,_ensure_ascii = False, indent=2)
                                                                                                                                                            ...
                                                                                                                                                            def load_previous_operations(self) -> bool:
                                                                                                                                                                ...
                                                                                                                                                                try:
                                                                                                                                                                    if self.operations_log_file.exists():
                                                                                                                                                                        with_open(self.operations_log_file,_'r',_encoding = 'utf-8') as f:
                                                                                                                                                                            ...
                                                                                                                                                                            def generate_operations_report(self) -> str:
                                                                                                                                                                                ...
                                                                                                                                                                                POSCO_News_250808_ops =  sum(1 for op in self.operations_log if op.component == ComponentType.POSCO News 250808)
...
"""
                                                                                                                                                                                ...
                                                                                                                                                                                for operation in self.operations_log:
                                                                                                                                                                                    ...
                                                                                                                                                                                    report_+ =  f"{status} [{operation.operation_type.value}] {operation.source_path} → {operation.target_path}{rollback_status}/n"

                                                                                                                                                                                    if not operation.success and operation.error_message:
                                                                                                                                                                                        report += f"   오류: {operation.error_message}/n"
                                                                                                                                                                                    ...
                                                                                                                                                                                    def main():
                                                                                                                                                                                        ...
                                                                                                                                                                                        for key, value in summary.items():
                                                                                                                                                                                            ...
                                                                                                                                                                                            if choice == "1":
                                                                                                                                                                                                ...
                                                                                                                                                                                                print(f"/n모든 파일 변경 완료: {len(wh_operations + pn_operations)}개 작업")
                                                                                                                                                                                                ...
                                                                                                                                                                                                print(f"/n시뮬레이션 완료: {len(wh_operations + pn_operations)}개 작업 예정")

                                                                                                                                                                                            elif choice == "5":
                                                                                                                                                                                                success = renaming_system.rollback_operations()
                                                                                                                                                                                                print(f"/n롤백 {'성공' if success else '실패'}")
                                                                                                                                                                                                ...
                                                                                                                                                                                                # 보고서 파일로 저장
                                                                                                                                                                                                report_file = renaming_system.workspace_root / "file_renaming.log"
                                                                                                                                                                                                with_open(report_file,_'w',_encoding = 'utf-8') as f:
                                                                                                                                                                                                    f.write(report)
                                                                                                                                                                                                    print(f"/n보고서 저장: {report_file}")
