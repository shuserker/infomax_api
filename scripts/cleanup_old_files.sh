...
OLD_SCRIPTS=(
    ".naming_backup/scripts/.naming_backup/scripts/🎛️POSCO_제어센터_실행_v2.bat"
    "🎛️POSCO_제어센터_실행_v2.sh"
    "🎛️POSCO_제어센터_실행.bat"
    ".naming_backup/scripts/🎛️POSCO_제어센터_Mac실행.command"
    "🐹워치햄스터_총괄_관리_센터_SIMPLE.bat"
    ".naming_backup/config_data_backup/watchhamster.log"
    "🐹워치햄스터_총괄_관리_센터.bat"
    ".naming_backup/scripts/.naming_backup/scripts/🐹워치햄스터_통합_관리_센터.bat"
    "watchhamster_master_control.ps1"
    ".naming_backup/scripts/.naming_backup/scripts/watchhamster_master_control.sh"
    "Monitoring/POSCO_News_250808/Monitoring/POSCO_News_250808/posco_news_250808_control_center.sh"
    "posco_control_center.ps1"
    ".naming_backup/scripts/.naming_backup/scripts/posco_control_mac.sh"
)
...
# 임시 파일들 백업 후 삭제
TEMP_FILES=(
    ".naming_backup/scripts/.naming_backup/scripts/🚀POSCO_메인_알림_시작_직접.bat"
    ".naming_backup/scripts/.naming_backup/scripts/🚀POSCO_메인_알림_시작_직접.sh"
    "POSCO_시작.bat"
    "🔄Git_덮어씌우기.bat"
)
