...
if command -v python3 &> /dev/null; then
    ...
    # Python 3.8+ 확인
# BROKEN_REF:     if python3 -c "import sys; exit(0 if sys.version_info >= (3, 8) else 1)"; then
...
if [ -f ".naming_backup/scripts/.naming_backup/scripts/watchhamster_control_center.sh" ]; then
