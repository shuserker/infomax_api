...
class ControlCenterTester:
    ...
    def __init__(self):
        ...
        self.control_center_script = os.path.join(self.script_dir, 'watchhamster_control_center.sh')
        self.test_results = []
    ...
    def test_required_functions(self):
        ...
        try:
            with open(self.control_center_script, 'r', encoding='utf-8') as f:
    ...
    def test_dependency_scripts(self):
        ...
        try:
            ...
            # 워치햄스터 스크립트 확인
            watchhamster_script = os.path.join(self.script_dir, 'Monitoring', 'Posco_News_mini', 'monitor_WatchHamster.py')
