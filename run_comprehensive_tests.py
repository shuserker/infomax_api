...
종합적인 테스트 프레임워크 실행기
- 모든 테스트 스크립트를 순차적으로 실행
- 테스트 결과 통합 및 보고서 생성
- 실패한 테스트에 대한 상세 분석 제공
...
class ComprehensiveTestRunner:
    ...
    def run_single_test(self, test_config: Dict) -> Dict:
        ...
        try:
            ...
            ], capture_output=True, text=True, timeout=timeout, cwd=self.script_dir)
    ...
    def generate_summary_report(self) -> str:
        ...
        for result in self.test_results.values():
            ...
            total_individual_tests += analysis['total_tests']
            total_passed_tests += analysis['passed_tests']
            total_failed_tests += analysis['failed_tests']
...
"""
                ...
                if not result['success']:
                    report += f"• 오류: {result.get('error_message', 'Unknown error')}\n"
                
                if analysis['warnings']:
                    report += f"• 경고: {len(analysis['warnings'])}개\n"
...
"""
            ...
            report += f"""⚠️ {failed_scripts}개의 테스트 스크립트가 실패했습니다.
...
"""
    ...
    def run_all_tests(self) -> bool:
        ...
        self.print_header("🚀 POSCO WatchHamster v2 종합 테스트 프레임워크")
        ...
        if critical_failures == 0:
            ...
            print(f"\n❌ 중요 테스트 {critical_failures}개가 실패했습니다.")
