        ...
        """
                                    ...
                                    def _convert_filename(self, filename: str, component: ComponentType) -> str:
                                        ...
                                        def _convert_watchhamster_filename(self, filename: str) -> str:
                                            ...
                                            patterns = [
                                            (r'WatchHamster v3.0', 'WatchHamster_v3_v3_0_Control_Center'),
                                            (r'WatchHamster v3.0_v3_0_Integrated_Center'),
                                            (r'POSCO_제어센터_실행_v2', 'WatchHamster_v3_v3_0_Control_Panel'),
                                            (r'demo_v2_integration', 'demo_watchhamster_v3_v3_0_integration'),
                                            (r'test_v2_integration', 'test_watchhamster_v3_v3_0_integration'),
                                            (r'test_v2_notification', 'test_watchhamster_v3_v3_0_notification'),
                                            ...
                                            def _convert_POSCO News 250808 250808_filename(self, filename: str) -> str:
                                                ...
                                                patterns = [
# REMOVED:                                                 (r'POSCO News 250808_mini/.py', 'POSCO_News_250808.py'),
...
# REMOVED:                                                 (r'POSCO News 250808 250808_data/.json', 'POSCO News 250808 250808_250808_data.json'),
# REMOVED:                                                 (r'POSCO News 250808 250808_cache/.json', 'POSCO News 250808 250808_250808_cache.json'),
# REMOVED:                                                 (r'POSCO News 250808 250808_historical_cache/.json', 'POSCO News 250808 250808_250808_historical.json'),
                                                ]
