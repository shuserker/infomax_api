#!/bin/bash
# ============================================================================
# Watchhamster V3.0 Control Center
# POSCO 시스템 제어센터
# 
...
start_watchhamster() {
    ...
    if [[ ! -f "Monitoring/POSCO_News_250808/monitor_WatchHamster_v3.0.py" ]]; then
        ...
        print_info "Monitoring/POSCO_News_250808/monitor_WatchHamster_v3.0.py"
        echo
        read -p "계속하려면 Enter를 누르세요..."
        main_menu
        return 1
...
stop_watchhamster() {
    ...
    # 1. 워치햄스터 메인 프로세스 중지
    local watchhamster_pid=$(pgrep -f "Monitoring/POSCO_News_250808/Monitoring/POSCO_News_250808/monitor_WatchHamster_v3.0.py")
...
# BROKEN_REF:     local processes=("POSCO News 250808_monitor.py" "Monitoring/POSCO_News_250808/Monitoring/POSCO_News_250808/integrated_report_scheduler.py" "Monitoring/POSCO_News_250808/Monitoring/POSCO_News_250808/historical_data_collector.py")
    ...
    for process in "Monitoring/POSCO_News_250808/Monitoring/POSCO_News_250808/monitor_WatchHamster_v3.0.py" "${processes[@]}"; do
...
check_watchhamster_status() {
    ...
    if pgrep -f "Monitoring/POSCO_News_250808/Monitoring/POSCO_News_250808/monitor_WatchHamster_v3.0.py" > /dev/null; then
        WATCHHAMSTER_PID=$(pgrep -f "Monitoring/POSCO_News_250808/Monitoring/POSCO_News_250808/monitor_WatchHamster_v3.0.py")
...
check_system_status() {
    ...
    local required_files=("Monitoring/POSCO_News_250808/posco_main_notifier.py" "Monitoring/POSCO_News_250808/monitor_WatchHamster_v3.0.py" "Monitoring/POSCO_News_250808/config.py" "requirements.txt")
...
# BROKEN_REF:         if python3 -c "import sys; print('Python 스크립트 테스트 통과')" 2>/dev/null; then
    ...
    elif [[ -f "Monitoring/POSCO_News_250808/monitor_WatchHamster_v3.0.py" ]]; then
# BROKEN_REF:         if python3 -c "import sys; print('Python 스크립트 테스트 통과')" 2>/dev/null; then
