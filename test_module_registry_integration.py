...
# -*- coding: utf-8 -*-
"""
ModuleRegistry 통합 테스트 스크립트

POSCO 워치햄스터 v2 ModuleRegistry 통합이 올바르게 작동하는지 테스트합니다.
"""
...
def test_modules_json_exists():
    ...
    modules_json_path = os.path.join(current_dir, 'Monitoring', 'Posco_News_mini', 'modules.json')
...
def test_v2_module_registry_import():
    """v2 ModuleRegistry import 테스트"""
    print("\n🔍 2. v2 ModuleRegistry import 테스트...")
    ...
    try:
        ...
        print("✅ ModuleRegistry import 성공")
        ...
        print(f"❌ ModuleRegistry import 실패: {e}")
        return False
    except Exception as e:
        print(f"❌ ModuleRegistry 테스트 실패: {e}")
        return False

def test_watchhamster_v2_integration():
    """워치햄스터 v2 통합 테스트"""
    print("\n🔍 3. 워치햄스터 v2 통합 테스트...")
    ...
    try:
        ...
        print("✅ PoscoMonitorWatchHamster import 성공")
        
        # 워치햄스터 초기화 (실제 실행하지 않고 초기화만)
        print("🔧 워치햄스터 초기화 중...")
        ...
        print(f"🎯 v2 아키텍처 활성화: {v2_status.get('v2_enabled', False)}")
        
        if v2_status.get('v2_enabled'):
            print("🎉 v2 아키텍처 활성화됨!")
        ...
        print(f"❌ 워치햄스터 import 실패: {e}")
        return False
    except Exception as e:
        print(f"❌ 워치햄스터 v2 통합 테스트 실패: {e}")
        import traceback
...
def test_module_control_functions():
    ...
    try:
        ...
        if not watchhamster.v2_enabled:
...
def main():
    """메인 테스트 실행"""
    print("🧪 POSCO 워치햄스터 v2 ModuleRegistry 통합 테스트 시작")
    print("=" * 60)
    ...
    test_results.append(("워치햄스터 v2 통합", test_watchhamster_v2_integration()))
