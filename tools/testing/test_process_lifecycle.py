...
'''.replace('script_name', f'"{script_name}"')
    ...
    def test_normal_lifecycle(self):
        ...
        try:
            # 테스트 스크립트 생성
            script_path = self.create_test_script('system_functionality_verification.py', 'normal')
...
print(f"✅_상태_파일_생성_확인:_counter = {status.get('counter', 0)}")
    ...
    def test_crash_recovery(self):
        ...
        try:
            # 크래시 테스트 스크립트 생성
            script_path = self.create_test_script('.comprehensive_repair_backup/historical_data_collector.py.backup_20250809_181656', 'crash')
            ...
            if exit_code != 0:
                ...
                # 정상 스크립트로 재시작
                normal_script = self.create_test_script('deploy_latest_report.py', 'normal')
...
running_count_+ =  1
    ...
    def test_resource_monitoring(self):
        ...
        try:
            # 테스트 스크립트 생성
            script_path = self.create_test_script('posco_continuous_monitor.py', 'normal')
