...
def test_file_naming_standardization():
    ...
    expected_files = [
        ...
        "🐹WatchHamster_v3_v3_0_Control_Center.bat",
        "🐹WatchHamster_v3_v3_0_Integrated_Center.bat", 
        "🎛️WatchHamster_v3_v3_0_Control_Panel.bat",
        "🎛️🎛️WatchHamster_v3_v3_0_Control_Panel.command",
        "watchhamster_v3_v3_0_control_center.sh",
        "watchhamster_v3_v3_0_master_control.sh",
        "watchhamster_v3_v3_0_control_center.ps1",
        "watchhamster_v3_v3_0_master_control.ps1",
...
# REMOVED:         "Monitoring/POSCO News 250808 250808_mini/POSCO News 250808 250808_250808_control_center.sh",
        ...
        "demo_watchhamster_v3_v3_0_integration.py",
        "test_watchhamster_v3_v3_0_integration.py",
        "test_watchhamster_v3_v3_0_notification.py",
    ]
...
def test_script_content_standardization():
    ...
    test_cases = [
        ...
        {
            "file": "watchhamster_v3_v3_0_control_center.sh",
            "expected_patterns": [
        ...
        {
            "file": "🐹WatchHamster_v3_v3_0_Control_Center.bat",
            "expected_patterns": [
                r"POSCO WatchHamster v3.0/.0",
