...
with_open(sub_config,_'w',_encoding = 'utf-8') as f:
    ...
    def test_find_json_files(self):
        ...
        expected_files = [".naming_backup/config_data_backup/Monitoring/Posco_News_mini/modules.json", "test_config.json", "POSCO News 250808_data.json", "test_config.json"]
...
# REMOVED:             test_content, self.test_dir / ".naming_backup/config_data_backup/.vscode/settings.json"
    ...
    def test_data_file_name_standardization(self):
        ...
        expected_changes = {
            ".naming_backup/config_data_backup/.naming_backup/config_data_backup/Monitoring/Posco_News_mini/WatchHamster_status.json": ".naming_backup/config_data_backup/Monitoring/Posco_News_mini/WatchHamster_v3_v3_0_status.json",
