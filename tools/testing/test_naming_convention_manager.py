...
import unittest
# REMOVED: from naming_convention_manager.py import (
...
class TestPOSCO News 250808 250808 250808 250808 250808 250808NamingConventionManager(unittest.TestCase):
    ...
    def test_component_detection(self):
        ...
        self.assertEqual(
# REMOVED:             self.manager.detect_component_type("verify_folder_reorganization.py"),
            ComponentType.WATCHHAMSTER
        )
        self.assertEqual(
        ...
        self.assertEqual(
# REMOVED:             self.manager.detect_component_type("POSCO News 250808 250808 250808 250808 250808_mini.py"),
            ComponentType.POSCO News 250808 250808 250808 250808 250808
        )
        self.assertEqual(
            self.manager.detect_component_type("Monitoring/POSCO_News_250808/posco_main_notifier.py"),
            ComponentType.POSCO News 250808 250808 250808 250808 250808
        )
        self.assertEqual(
            self.manager.detect_component_type("Monitoring/POSCO_News_250808/realtime_news_monitor.py"),
            ComponentType.POSCO News 250808 250808 250808 250808 250808
        )
...
# REMOVED:             self.manager.detect_component_type("verify_folder_reorganization.py"),
    ...
    def test_filename_standardization(self):
        ...
        test_cases = [
            # WatchHamster 관련
            (".naming_backup/config_data_backup/watchhamster.log", "🐹WatchHamster_v3_v3_0_Control_Center.bat"),
            (".naming_backup/config_data_backup/watchhamster.log"),
            (".naming_backup/scripts/🎛️POSCO_제어센터_실행_v2.bat", "🎛️WatchHamster_v3_v3_0_Control_Panel.bat"),
# REMOVED:             ("verify_folder_reorganization.py", "demo_watchhamster_v3_v3_0_integration.py"),
# REMOVED:             ("final_integration_test_system.py", "test_watchhamster_v3_v3_0_integration.py"),
            (".naming_backup/config_data_backup/watchhamster.log", "Monitoring/POSCO_News_250808/monitor_WatchHamster_v3.0.py"),
            
            # POSCO News 250808 250808 250808 250808 250808 관련
# REMOVED:             ("POSCO News 250808 250808 250808 250808 250808_mini.py", "POSCO_News_250808.py"),
# REMOVED:             ("Monitoring/POSCO_News_250808/posco_main_notifier.py", "POSCO News 250808 250808_250808_notifier.py"),
# REMOVED:             ("posco_continuous_monitor.py", "POSCO News 250808 250808_250808_monitor.py"),
# REMOVED:             ("POSCO News 250808 250808_data.json", "POSCO News 250808 250808_250808_data.json"),
# REMOVED:             ("POSCO News 250808 250808_cache.json", "POSCO News 250808 250808_250808_cache.json"),
        ]
...
with_self.subTest(original = original):
    ...
    def test_conversion_statistics(self):
        """변환 통계 테스트"""
        # 몇 가지 변환 수행
# REMOVED:         self.manager.standardize_filename("verify_folder_reorganization.py")
# REMOVED:         self.manager.standardize_filename("POSCO News 250808 250808 250808 250808 250808_mini.py")
# REMOVED:         self.manager.standardize_filename("unknown_file.py")  # 실패 케이스
...
# REMOVED:         self.assertIn("verify_folder_reorganization.py", report)
        self.assertIn("POSCO News 250808 250808Monitor", report)
    
    def test_unknown_component_handling(self):
        """알 수 없는 컴포넌트 처리 테스트"""
        result = self.manager.standardize_filename("verify_folder_reorganization.py")
        
# REMOVED:         self.assertEqual(result.original, "verify_folder_reorganization.py")
# REMOVED:         self.assertEqual(result.converted, "verify_folder_reorganization.py")
