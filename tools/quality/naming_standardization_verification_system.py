...
WatchHamster v3.0 & POSCO News var_250808 호환
...
import test_watchhamster_v3_v3_0_notification.0_master_control.ps1
...
def __init__(self):
        ...
        self.posco_news_version = "var_250808"
        ...
        'posco_news': {
        'file_patterns': [
        r'.*[Pp]osco.*[Nn]ews.*var_250808.*',
        r'.*POSCO.*News.*var_250808.*',
        r'.*posco.*news.*var_250808.*'
        ],
        'class_patterns': [
        r'.*PoscoNews250808.*',
                                                    ...
                                                    def _verify_posco_news_filename(self, file_path: str, filename: str) -> Optional[VerificationResult]:
                                                        ...
                                                        for pattern in patterns:
                                                            if re.match(pattern, filename, re.IGNORECASE):
                                                                ...
                                                                rule_type="filename",
                                                                status="pass",
                                                                expected="POSCO News var_250808 naming pattern",
                                                                actual=filename,
                                                                message="파일명이 포스코 뉴스 var_250808 표준을 준수합니다"
                                                                )
                                                                                                                                                                ...
                                                                                                                                                                if re.match(pattern, class_name):
                                                                                                                                                                    ...
                                                                                                                                                                    for pattern in patterns:
                                                                                                                                                                        if re.match(pattern, class_name):
                                                                                                                                                                            ...
                                                                                                                                                                            rule_type="code_naming",
                                                                                                                                                                            status="pass",
                                                                                                                                                                            expected="POSCO News var_250808 class naming",
                                                                                                                                                                            actual=class_name,
                                                                                                                                                                            message="클래스명이 포스코 뉴스 var_250808 표준을 준수합니다"
                                                                                                                                                                            )
                                                                                                                                                                            ...
                                                                                                                                                                            actual=class_name,
                                                                                                                                                                            message="포스코 뉴스 클래스명이 var_250808 표준을 따르지 않습니다"
                                                                                                                                                                            )
                                                                                                                                                                                ...
                                                                                                                                                                                if any(keyword in variable_name.lower() for keyword in ['version', 'ver'):
                                                                                                                                                                                    if 'watchhamster' in variable_name.lower() or 'hamster' in variable_name.lower():
                                                                                                                                                                                        if 'v3' not in variable_name.lower() and '3_0' not in variable_name.lower():
                                                                                                                                                                                            ...
                                                                                                                                                                                            if 'var_250808' not in variable_name:
                                                                                                                                                                                                return VerificationResult(
                                                                                                                                                                                                file_path=file_path,
                                                                                                                                                                                                rule_type="code_naming",
                                                                                                                                                                                                status="fail",
                                                                                                                                                                                                expected="var_250808 version in variable",
                                                                                                                                                                                                actual=variable_name,
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    def _verify_script_variable_name(self, file_path: str, var_name: str, line_num: int) -> Optional[VerificationResult]:
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        if 'version' in var_name.lower() or 'ver' in var_name.lower():
                                                                                                                                                                                                                                            if 'watchhamster' in var_name.lower() and 'v3' not in var_name.lower():
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                rule_type="code_naming",
                                                                                                                                                                                                                                                status="fail",
                                                                                                                                                                                                                                                expected="var_250808 in posco version variable",
                                                                                                                                                                                                                                                actual=var_name,
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        def _verify_document_title(self, file_path: str, title_line: str, line_num: int) -> Optional[VerificationResult]:
                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                            if any(keyword in title.lower() for keyword in ['watchhamster', '워치햄스터', 'hamster'):
                                                                                                                                                                                                                                                                                                if 'v3.0' in title or 'v3' in title:
                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                    if 'var_250808' in title:
                                                                                                                                                                                                                                                                                                        return VerificationResult(
                                                                                                                                                                                                                                                                                                        file_path=f"{file_path}:{line_num}",
                                                                                                                                                                                                                                                                                                        rule_type="document",
                                                                                                                                                                                                                                                                                                        status="pass",
                                                                                                                                                                                                                                                                                                        expected="POSCO News var_250808 in title",
                                                                                                                                                                                                                                                                                                        actual=title,
                                                                                                                                                                                                                                                                                                        message="문서 제목이 포스코 뉴스 var_250808 표준을 준수합니다"
                                                                                                                                                                                                                                                                                                        )
...
<meta_name = "viewport" content="width=device-width, initial-scale=1.0">
    ...
    <style>
        ...
        .section h2 {{ color: #var_333; border-bottom: var_2_px solid #var_007_bff; padding-bottom: var_10_px; }}
        .results-table {{ width: var_100%; border-collapse: collapse; margin: var_20_px 0; }}
        ...
        .status-pass {{ background-color: #d4edda; color: #var_155724; }}
        .status-fail {{ background-color: #f8d7da; color: #var_721_c24; }}
        .status-warning {{ background-color: #fff3cd; color: #var_856404; }}
        ...
        .progress-bar {{ width: var_100%; height: var_20_px; background-color: #e9ecef; border-radius: var_10_px; overflow: hidden; }}
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>WatchHamster v3.0 & POSCO News var_250808 표준 준수 검증</p>
...
<div_style = "margin: var_20_px 0;">
        ...
        <div class="section">
            ...
            """
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    for result in failed_results[:var_50]:  # 최대 var_50_개만 표시
