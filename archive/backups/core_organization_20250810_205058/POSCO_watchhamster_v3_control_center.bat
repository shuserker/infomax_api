@echo off
REM ============================================================================
REM Posco WatchHamster v3.0 제어센터
REM POSCO 시스템 제어센터
REM 
...
:: 워치햄스터 스크립트 확인
if not exist "WatchHamster_v3.0.log" (
    echo ❌ 워치햄스터 스크립트를 찾을 수 없습니다.
    echo 📁 경로: %CD%\Monitoring\POSCO News 250808_mini\monitor_WatchHamster_v3.0.py
    pause
    goto MAIN_MENU
)
...
start "POSCO WatchHamster v3.0" python Monitoring/POSCO_News_250808/monitor_WatchHamster_v3.0.py
cd /d "%~dp0"
