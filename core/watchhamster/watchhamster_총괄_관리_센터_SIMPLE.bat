...
echo %BLUE%╠═══════════════════════════════════════════════════════════════════════════════╣%RESET%
echo %BLUE%║  %YELLOW%A.%RESET% 전체 시스템 상태     - 모든 WatchHamster v3.0 상태 확인                    %BLUE%║%RESET%
...
echo %CYAN%WatchHamster v3.0.0 (간단 버전)%RESET%
...
# BROKEN_REF: if exist "POSCO_통합_관리_센터_SIMPLE.bat" (
# BROKEN_REF:     call "POSCO_통합_관리_센터_SIMPLE.bat"
